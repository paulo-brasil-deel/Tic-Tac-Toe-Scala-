...
$c_LJogo$.prototype.init___ = (function() {
  $n_LJogo$ = this;
  var arr = $newArrayObject($d_LCasa.getArrayOf().getArrayOf(), [3]);
  var i = 0;
  while (true) {
    var v1 = i;
    arr.set(v1, $newArrayObject($d_LCasa.getArrayOf(), [3]));
    if ((i === 2)) {
      break
    };
    i = ((1 + i) | 0)
  };
  this.tabuleiro$1 = arr;
  this.nomeTema$1 = "novo";
  this.jogador1$1 = new $c_LJogador().init___T__T("Diego", "x");
  this.jogador2$1 = new $c_LJogador().init___T__T("Eduarda", "o");
  this.jogadorAtual$1 = this.jogador1$1;
  return this
});
$c_LJogo$.prototype.checarVitoria__AALCasa__I__I__LJogador__Z = (function(tabAtual, x, y, jogador) {
  return (this.verificarVertical$1__p1__I__AALCasa__I__LJogador__Z(0, tabAtual, y, jogador) || (this.verificarHorizontal$1__p1__I__AALCasa__I__LJogador__Z(0, tabAtual, x, jogador) || this.verificarDiagonal$1__p1__AALCasa__LJogador__Z(tabAtual, jogador)))
});
$c_LJogo$.prototype.verifDiagonalAscendente$1__p1__I__I__AALCasa__LJogador__Z = (function(x, y, tabAtual$1, jogador$1) {
  _verifDiagonalAscendente: while (true) {
    if ((((((x + y) | 0) === 2) && tabAtual$1.get(x).get(y).ocupada$1) && tabAtual$1.get(x).get(y).jogador$1.equals__O__Z(jogador$1))) {
      if ((x === 0)) {
        return true
      } else {
        var temp$x = (((-1) + x) | 0);
        ...
        x = temp$x;
        y = temp$y;
        continue _verifDiagonalAscendente
      }
    } else {
      return false
    }
...
$c_LJogo$.prototype.verificarVertical$1__p1__I__AALCasa__I__LJogador__Z = (function(x, tabAtual$1, y$1, jogador$1) {
  _verificarVertical: while (true) {
    if ((tabAtual$1.get(x).get(y$1).ocupada$1 && tabAtual$1.get(x).get(y$1).jogador$1.equals__O__Z(jogador$1))) {
      if ((x === 2)) {
        return true
      } else {
        x = ((1 + x) | 0);
        continue _verificarVertical
      }
    } else {
      return false
    }
...
$c_LJogo$.prototype.getButtonClass__T__V = (function(classeBotao) {
  var e = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("console");
  e.innerHTML = classeBotao
});
$c_LJogo$.prototype.checarEmpate__AALCasa__I__I__Z = (function(tabAtual, x, y) {
  _checarEmpate: while (true) {
    if ((x > 2)) {
      return true
    } else if (tabAtual.get(x).get(y).ocupada$1) {
      if ((y === 2)) {
        var temp$x = ((1 + x) | 0);
        x = temp$x;
        y = 0;
...
$c_LJogo$.prototype.verifDiagonalDescendente$1__p1__I__I__AALCasa__LJogador__Z = (function(x, y, tabAtual$1, jogador$1) {
  _verifDiagonalDescendente: while (true) {
    if ((((x === y) && tabAtual$1.get(x).get(y).ocupada$1) && tabAtual$1.get(x).get(y).jogador$1.equals__O__Z(jogador$1))) {
      if ((x === 2)) {
        return true
      } else {
        var temp$x = ((1 + x) | 0);
        ...
        x = temp$x;
        y = temp$y;
        continue _verifDiagonalDescendente
      }
    } else {
      return false
    }
...
$c_LJogo$.prototype.checarJogadaValida__AALCasa__I__I__Z = (function(tabuleiro, x, y) {
  return (!tabuleiro.get(x).get(y).ocupada$1)
});
$c_LJogo$.prototype.atualizarTabuleiro__AALCasa__I__I__V = (function(array, x, y) {
  this.tabuleiro$1.get(x).set(y, new $c_LCasa().init___LJogador__Z(this.jogadorAtual$1, true))
});
$c_LJogo$.prototype.iniciarJogo__V = (function() {
  var array = [new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false), new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false), new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false)];
  ...
  var array$2 = [new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false), new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false), new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false)];
  ...
  var elem$1$1 = 0;
  elem$1$1 = 0;
  var this$12 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$1, 0, $uI(xs$1.array$6.length));
  while (this$12.hasNext__Z()) {
    var arg1$1 = this$12.next__O();
    array$3.set(elem$1$1, arg1$1);
    elem$1$1 = ((1 + elem$1$1) | 0)
  };
  var array$4 = [new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false), new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false), new $c_LCasa().init___LJogador__Z($m_LCasa$().apply$default$1__LJogador(), false)];
  ...
  var elem$1$2 = 0;
  elem$1$2 = 0;
  var this$18 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$2, 0, $uI(xs$2.array$6.length));
  while (this$18.hasNext__Z()) {
    var arg1$2 = this$18.next__O();
  ...
  var elem$1$3 = 0;
  elem$1$3 = 0;
  var this$26 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$3, 0, $uI(xs$3.array$6.length));
  while (this$26.hasNext__Z()) {
    var arg1$3 = this$26.next__O();
    array$7.set(elem$1$3, arg1$3);
    elem$1$3 = ((1 + elem$1$3) | 0)
  };
  this.tabuleiro$1 = array$7;
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("jogador1").innerHTML = this.jogador1$1.nome$1;
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("jogador2").innerHTML = this.jogador2$1.nome$1;
...
$c_LJogo$.prototype.verificarHorizontal$1__p1__I__AALCasa__I__LJogador__Z = (function(y, tabAtual$1, x$1, jogador$1) {
  _verificarHorizontal: while (true) {
    if ((tabAtual$1.get(x$1).get(y).ocupada$1 && tabAtual$1.get(x$1).get(y).jogador$1.equals__O__Z(jogador$1))) {
      if ((y === 2)) {
        return true
      } else {
        y = ((1 + y) | 0);
        continue _verificarHorizontal
      }
    } else {
      return false
    }
...
$c_LJogo$.prototype.verificarDiagonal$1__p1__AALCasa__LJogador__Z = (function(tabAtual$1, jogador$1) {
  return (this.verifDiagonalAscendente$1__p1__I__I__AALCasa__LJogador__Z(2, 0, tabAtual$1, jogador$1) || this.verifDiagonalDescendente$1__p1__I__I__AALCasa__LJogador__Z(0, 0, tabAtual$1, jogador$1))
});
$c_LJogo$.prototype.jogar__T__V = (function(posGrid) {
  ...
  if (this.checarJogadaValida__AALCasa__I__I__Z(this.tabuleiro$1, x, y)) {
    var casa = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(posGrid);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("jogadorAtual");
    this.atualizarTabuleiro__AALCasa__I__I__V(this.tabuleiro$1, x, y);
    casa.innerHTML = (((("<img src=\"../resources/" + this.nomeTema$1) + "/") + this.jogadorAtual$1.nomeImg$1) + ".png\"/>");
    if (this.checarVitoria__AALCasa__I__I__LJogador__Z(this.tabuleiro$1, x, y, this.jogadorAtual$1)) {
      var texto = ("Parabens, " + this.jogadorAtual$1.nome$1);
      var this$12 = $m_s_Console$();
      var this$13 = $as_Ljava_io_PrintStream(this$12.outVar$2.v$1);
      this$13.java$lang$JSConsoleBasedPrintStream$$printString__T__V((texto + "\n"))
    } else if (this.checarEmpate__AALCasa__I__I__Z(this.tabuleiro$1, 0, 0)) {
      var this$15 = $m_s_Console$();
      var this$16 = $as_Ljava_io_PrintStream(this$15.outVar$2.v$1);
      this$16.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Empate!\n")
    } else if (this.jogadorAtual$1.equals__O__Z(this.jogador1$1)) {
    ...
    this$19.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Jogada Errada\n")
  }
});
...
function $c_LMenu$() {
  $c_O.call(this);
  this.nomeJogador1$1 = null;
  this.nomeJogador2$1 = null;
  this.nomeTema$1 = null
}
...
$c_LMenu$.prototype.init___ = (function() {
  this.nomeJogador1$1 = "Jogador 1";
  this.nomeJogador2$1 = "Jogador 2";
  this.nomeTema$1 = "classico";
  return this
});
$c_LMenu$.prototype.selecionarDoisJogadores__V = (function() {
  var botaoDoisJog = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("doisJogBotao");
  botaoDoisJog.setAttribute("class", "botaoTransparente");
  var botaoUmJog = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("umJogBotao");
  botaoUmJog.setAttribute("class", "botaoOpaco");
  var entrada2 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("entradaJogador2");
  entrada2.style.display = "block"
});
$c_LMenu$.prototype.selecionarUmJogador__V = (function() {
  var botaoDoisJog = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("doisJogBotao");
...
$c_LCasa$.prototype = new $h_sr_AbstractFunction2();
$c_LCasa$.prototype.constructor = $c_LCasa$;
/** @constructor */
function $h_LCasa$() {
  /*<skip>*/
...
$h_LCasa$.prototype = $c_LCasa$.prototype;
$c_LCasa$.prototype.init___ = (function() {
  return this
});
$c_LCasa$.prototype.apply$default$1__LJogador = (function() {
  return new $c_LJogador().init___T__T("", "")
});
$c_LCasa$.prototype.toString__T = (function() {
  return "Casa"
});
...
$c_LJogador.prototype.init___T__T = (function(nome, nomeImg) {
  this.nome$1 = nome;
  this.nomeImg$1 = nomeImg;
  return this
});
$c_LJogador.prototype.productPrefix__T = (function() {
  return "Jogador"
});
$c_LJogador.prototype.productArity__I = (function() {
  return 2
});
$c_LJogador.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LJogador(x$1)) {
    var Jogador$1 = $as_LJogador(x$1);
    return ((this.nome$1 === Jogador$1.nome$1) && (this.nomeImg$1 === Jogador$1.nomeImg$1))
  } else {
    return false
  }
});
$c_LJogador.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.nome$1;
      break
...
$c_LJogador.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LJogador.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LJogador.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LJogador(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LJogador)))
}
function $as_LJogador(obj) {
  return (($is_LJogador(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Jogador"))
}
function $isArrayOf_LJogador(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LJogador)))
}
function $asArrayOf_LJogador(obj, depth) {
  return (($isArrayOf_LJogador(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LJogador;", depth))
}
...
$e.jogar = (function(arg$1) {
  ...
  $m_LJogo$().jogar__T__V(prep0)
});
$e.iniciarJogo = (function() {
  $m_LJogo$().iniciarJogo__V()
});
$e.getClass = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  $m_LJogo$().getButtonClass__T__V(prep0)
});
$e.selecionarUmJogador = (function() {
  $m_LMenu$().selecionarUmJogador__V()
});
$e.escolherTema = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  $m_LMenu$().escolherTema__T__V(prep0)
});
$e.selecionarDoisJogadores = (function() {
  $m_LMenu$().selecionarDoisJogadores__V()
});
}).call(this);
