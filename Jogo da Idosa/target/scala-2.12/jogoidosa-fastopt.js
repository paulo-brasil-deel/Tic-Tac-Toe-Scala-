...
$c_LJogador.prototype = new $h_O();
$c_LJogador.prototype.constructor = $c_LJogador;
/** @constructor */
function $h_LJogador() {
  /*<skip>*/
}
$h_LJogador.prototype = $c_LJogador.prototype;
$c_LJogador.prototype.init___T = (function(nomeImg) {
  this.nomeImg$1 = nomeImg;
  return this
});
var $d_LJogador = new $TypeData().initClass({
  LJogador: 0
}, false, "Jogador", {
  LJogador: 1,
  O: 1
});
$c_LJogador.prototype.$classData = $d_LJogador;
/** @constructor */
function $c_LJogo$() {
  $c_O.call(this);
  this.tab$1 = null;
  this.tema$1 = null;
  this.isUmJogador$1 = false;
  this.jogador1$1 = null;
  this.jogador2$1 = null;
  this.jogadorAtual$1 = null
}
$c_LJogo$.prototype = new $h_O();
$c_LJogo$.prototype.constructor = $c_LJogo$;
/** @constructor */
function $h_LJogo$() {
  /*<skip>*/
}
$h_LJogo$.prototype = $c_LJogo$.prototype;
$c_LJogo$.prototype.verifDiagonalAscendente$1__p1__I__I__LJogador__sci_List = (function(x, y, jogador$1) {
  if ((((((x + y) | 0) === 2) && this.tab$1.tabuleiro$1.get(x).get(y).ocupada$1) && this.tab$1.tabuleiro$1.get(x).get(y).jogador$1.equals__O__Z(jogador$1))) {
    if ((x === 0)) {
      $m_sci_List$();
      var array = [((("" + x) + "") + y)];
      ...
      var proximo = this.verifDiagonalAscendente$1__p1__I__I__LJogador__sci_List((((-1) + x) | 0), ((1 + y) | 0), jogador$1);
      if ($f_sc_TraversableOnce__nonEmpty__Z(proximo)) {
        $m_sci_List$();
        var array$1 = [((("" + x) + "") + y)];
        ...
        var x$3 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$1, cbf$1));
        return proximo.$$colon$colon$colon__sci_List__sci_List(x$3)
      } else {
        return $m_sci_Nil$()
      }
    }
...
$c_LJogo$.prototype.duasPessoas__V = (function() {
  this.jogador2$1 = new $c_LJogador().init___T("o");
  this.isUmJogador$1 = false
});
$c_LJogo$.prototype.init___ = (function() {
  $n_LJogo$ = this;
  this.tab$1 = new $c_LTabuleiro().init___();
  this.tema$1 = new $c_LTemas().init___T($m_LMenu$().nomeTema$1);
  this.isUmJogador$1 = true;
  this.jogador1$1 = new $c_LJogador().init___T("x");
  this.jogador2$1 = new $c_LJogador().init___T("o");
  this.jogadorAtual$1 = this.jogador1$1;
  return this
});
$c_LJogo$.prototype.verificarVertical$1__p1__I__I__LJogador__sci_List = (function(x, y$1, jogador$1) {
  if ((this.tab$1.tabuleiro$1.get(x).get(y$1).ocupada$1 && this.tab$1.tabuleiro$1.get(x).get(y$1).jogador$1.equals__O__Z(jogador$1))) {
    if ((x === 2)) {
      $m_sci_List$();
      var array = [((("" + x) + "") + y$1)];
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
      ...
      var proximo = this.verificarVertical$1__p1__I__I__LJogador__sci_List(((1 + x) | 0), y$1, jogador$1);
      if ($f_sc_TraversableOnce__nonEmpty__Z(proximo)) {
        $m_sci_List$();
        var array$1 = [((("" + x) + "") + y$1)];
        var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1);
        var this$12 = $m_sci_List$();
        var cbf$1 = this$12.ReusableCBFInstance$2;
        var x$1 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$1, cbf$1));
        return proximo.$$colon$colon$colon__sci_List__sci_List(x$1)
      } else {
        return $m_sci_Nil$()
      }
    }
...
$c_LJogo$.prototype.umaPessoa__V = (function() {
  this.jogador2$1 = new $c_LComputador().init___T("o");
  this.isUmJogador$1 = true
});
$c_LJogo$.prototype.atualizarTabuleiro__LCoordenada__V = (function(xy) {
  this.tab$1.tabuleiro$1.get(xy.x$1).set(xy.y$1, new $c_LCasa().init___LJogador__Z(this.jogadorAtual$1, true))
});
$c_LJogo$.prototype.trocarJogador__V = (function() {
  var x = this.jogadorAtual$1;
  var x$2 = this.jogador1$1;
  if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
    this.jogadorAtual$1 = this.jogador2$1
  } else {
    this.jogadorAtual$1 = this.jogador1$1
  }
});
$c_LJogo$.prototype.checarEmpate__I__I__Z = (function(x, y) {
  _checarEmpate: while (true) {
    if ((x > 2)) {
      return true
    } else if (this.tab$1.tabuleiro$1.get(x).get(y).ocupada$1) {
      if ((y === 2)) {
        var temp$x = ((1 + x) | 0);
        x = temp$x;
        y = 0;
        continue _checarEmpate
      } else {
        y = ((1 + y) | 0);
        continue _checarEmpate
      }
...
$c_LJogo$.prototype.verificarHorizontal$1__p1__I__I__LJogador__sci_List = (function(y, x$5, jogador$1) {
  if ((this.tab$1.tabuleiro$1.get(x$5).get(y).ocupada$1 && this.tab$1.tabuleiro$1.get(x$5).get(y).jogador$1.equals__O__Z(jogador$1))) {
    if ((y === 2)) {
      $m_sci_List$();
      var array = [((("" + x$5) + "") + y)];
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
      ...
      var proximo = this.verificarHorizontal$1__p1__I__I__LJogador__sci_List(((1 + y) | 0), x$5, jogador$1);
      if ($f_sc_TraversableOnce__nonEmpty__Z(proximo)) {
        $m_sci_List$();
        var array$1 = [((("" + x$5) + "") + y)];
        var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1);
        var this$12 = $m_sci_List$();
        var cbf$1 = this$12.ReusableCBFInstance$2;
        var x$2 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$1, cbf$1));
        return proximo.$$colon$colon$colon__sci_List__sci_List(x$2)
      } else {
        return $m_sci_Nil$()
      }
    }
...
$c_LJogo$.prototype.converterIDParaCoordenada__T__V = (function(posGrid) {
  var this$2 = new $c_sci_StringOps().init___T(posGrid);
  var c = $f_sc_IndexedSeqOptimized__head__O(this$2);
  if ((c === null)) {
    var jsx$1 = 0
  } else {
    var this$4 = $as_jl_Character(c);
    var jsx$1 = this$4.value$1
  };
  var x = (((-48) + jsx$1) | 0);
  var this$6 = new $c_sci_StringOps().init___T(posGrid);
  var x$1 = $as_T($f_sc_IndexedSeqOptimized__tail__O(this$6));
  var this$8 = new $c_sci_StringOps().init___T(x$1);
  var this$10 = $m_jl_Integer$();
  var $$this = this$8.repr$1;
  var y = this$10.parseInt__T__I__I($$this, 10);
  this.jogar__LCoordenada__V(new $c_LCoordenada().init___I__I(x, y))
});
$c_LJogo$.prototype.jogarComputador__V = (function() {
  var jogadaIA = $as_LComputador(this.jogador2$1).jogarAuto__LCoordenada();
  this.jogar__LCoordenada__V(jogadaIA)
});
$c_LJogo$.prototype.iniciarJogo__V = (function() {
  this.tema$1.iniciarTemas__V()
});
$c_LJogo$.prototype.jogar__LCoordenada__V = (function(posGrid) {
  if (this.checarJogadaValida__LCoordenada__Z(posGrid)) {
    this.atualizarTabuleiro__LCoordenada__V(posGrid);
    this.tema$1.atualizarCasa__T__T__V((("" + posGrid.x$1) + posGrid.y$1), this.jogadorAtual$1.nomeImg$1);
    if (this.gerenciarFimDeJogo__I__I__Z(posGrid.x$1, posGrid.y$1)) {
      if (this.jogadorAtual$1.equals__O__Z(this.jogador1$1)) {
        this.tema$1.jogar1__V();
        this.trocarJogador__V();
        if (this.isUmJogador$1) {
          this.jogarComputador__V()
        }
      } else {
        this.tema$1.jogar2__V();
        this.trocarJogador__V()
      }
    }
  }
});
$c_LJogo$.prototype.verificarDiagonal$1__p1__LJogador__sci_List = (function(jogador$1) {
  var resultadoDiag = this.verifDiagonalAscendente$1__p1__I__I__LJogador__sci_List(2, 0, jogador$1);
  var x = resultadoDiag;
  var x$2 = $m_sci_Nil$();
  if ((!((x !== null) && x.equals__O__Z(x$2)))) {
    return resultadoDiag
  } else {
    resultadoDiag = this.verifDiagonalDescendente$1__p1__I__I__LJogador__sci_List(0, 0, jogador$1);
    var x$3 = resultadoDiag;
    var x$4 = $m_sci_Nil$();
    if ((!((x$3 !== null) && x$3.equals__O__Z(x$4)))) {
      return resultadoDiag
    } else {
      return $m_sci_Nil$()
    }
...
$c_LJogo$.prototype.checarVitoria__I__I__LJogador__sci_List = (function(x, y, jogador) {
  var resultado = this.verificarVertical$1__p1__I__I__LJogador__sci_List(0, y, jogador);
  var x$2 = resultado;
  var x$3 = $m_sci_Nil$();
  if ((!((x$2 !== null) && x$2.equals__O__Z(x$3)))) {
    return resultado
  } else {
    resultado = this.verificarHorizontal$1__p1__I__I__LJogador__sci_List(0, x, jogador);
    var x$4 = resultado;
    var x$5 = $m_sci_Nil$();
    if ((!((x$4 !== null) && x$4.equals__O__Z(x$5)))) {
      return resultado
    } else {
      resultado = this.verificarDiagonal$1__p1__LJogador__sci_List(jogador);
      var x$6 = resultado;
      var x$7 = $m_sci_Nil$();
      if ((!((x$6 !== null) && x$6.equals__O__Z(x$7)))) {
        return resultado
      } else {
        return $m_sci_Nil$()
      }
...
$c_LJogo$.prototype.verifDiagonalDescendente$1__p1__I__I__LJogador__sci_List = (function(x, y, jogador$1) {
  if ((((x === y) && this.tab$1.tabuleiro$1.get(x).get(y).ocupada$1) && this.tab$1.tabuleiro$1.get(x).get(y).jogador$1.equals__O__Z(jogador$1))) {
    if ((x === 2)) {
      $m_sci_List$();
      var array = [((("" + x) + "") + y)];
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
      ...
      var proximo = this.verifDiagonalDescendente$1__p1__I__I__LJogador__sci_List(((1 + x) | 0), ((1 + y) | 0), jogador$1);
      if ($f_sc_TraversableOnce__nonEmpty__Z(proximo)) {
        $m_sci_List$();
        var array$1 = [((("" + x) + "") + y)];
        var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1);
        var this$12 = $m_sci_List$();
        var cbf$1 = this$12.ReusableCBFInstance$2;
        var x$4 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$1, cbf$1));
        return proximo.$$colon$colon$colon__sci_List__sci_List(x$4)
      } else {
        return $m_sci_Nil$()
      }
    }
...
$c_LJogo$.prototype.checarJogadaValida__LCoordenada__Z = (function(xy) {
  return (!this.tab$1.tabuleiro$1.get(xy.x$1).get(xy.y$1).ocupada$1)
});
$c_LJogo$.prototype.travarTabuleiro__I__I__V = (function(x, y) {
  _travarTabuleiro: while (true) {
    if ((x <= 2)) {
      if ((!this.tab$1.tabuleiro$1.get(x).get(y).ocupada$1)) {
        this.tab$1.tabuleiro$1.get(x).set(y, new $c_LCasa().init___LJogador__Z(this.tab$1.tabuleiro$1.get(x).get(y).jogador$1, true))
      };
      if ((y === 2)) {
        var temp$x = ((1 + x) | 0);
        x = temp$x;
        y = 0;
        continue _travarTabuleiro
      } else {
        y = ((1 + y) | 0);
        continue _travarTabuleiro
      }
...
$c_LJogo$.prototype.gerenciarFimDeJogo__I__I__Z = (function(x, y) {
  var sequenciaVitoria = this.checarVitoria__I__I__LJogador__sci_List(x, y, this.jogadorAtual$1);
  var x$3 = $m_sci_Nil$();
  if ((!((sequenciaVitoria !== null) && sequenciaVitoria.equals__O__Z(x$3)))) {
    this.tema$1.mostrarSequenciaVitoria__sci_List__V(sequenciaVitoria);
    this.travarTabuleiro__I__I__V(0, 0);
    this.tema$1.terminarJogo__T__V(this.jogadorAtual$1.nomeImg$1);
    return false
  } else {
    return ((!this.checarEmpate__I__I__Z(0, 0)) || (this.tema$1.terminarJogoEmpate__V(), false))
  }
});
var $d_LJogo$ = new $TypeData().initClass({
  LJogo$: 0
}, false, "Jogo$", {
  LJogo$: 1,
  O: 1
});
$c_LJogo$.prototype.$classData = $d_LJogo$;
var $n_LJogo$ = (void 0);
function $m_LJogo$() {
  if ((!$n_LJogo$)) {
    $n_LJogo$ = new $c_LJogo$().init___()
  };
  return $n_LJogo$
}
/** @constructor */
function $c_LMenu$() {
  $c_O.call(this);
  this.nomeTema$1 = null;
  this.fundoTema$1 = null
}
$c_LMenu$.prototype = new $h_O();
$c_LMenu$.prototype.constructor = $c_LMenu$;
/** @constructor */
function $h_LMenu$() {
  /*<skip>*/
}
$h_LMenu$.prototype = $c_LMenu$.prototype;
$c_LMenu$.prototype.init___ = (function() {
  this.nomeTema$1 = "simples";
  this.fundoTema$1 = "";
  return this
});
$c_LMenu$.prototype.voltarMenu__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("menu").style.display = "block";
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("tela").style.display = "none"
});
$c_LMenu$.prototype.iniciarMenu__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("menu").style.display = "block";
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("tela").style.display = "none"
});
$c_LMenu$.prototype.iniciarJogo__V = (function() {
  if ($uZ($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("switch-shadow").checked)) {
    $m_LJogo$().duasPessoas__V()
  } else {
    $m_LJogo$().umaPessoa__V()
  };
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("menu").style.display = "none";
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("tela").style.display = "block"
});
$c_LMenu$.prototype.escolherTema__T__V = (function(id) {
  this.nomeTema$1 = id;
  var x1 = this.nomeTema$1;
  if ((x1 === "simples")) {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("temaEscolhidoLabel").innerHTML = "Simples";
    this.fundoTema$1 = "#ffffff"
  } else if ((x1 === "natal")) {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("temaEscolhidoLabel").innerHTML = "Natal";
    this.fundoTema$1 = "#f49797"
  } else if ((x1 === "jathon")) {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("temaEscolhidoLabel").innerHTML = "Java vs Phyton";
    this.fundoTema$1 = "#52b7ad"
  } else if ((x1 === "catDog")) {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("temaEscolhidoLabel").innerHTML = "Gato vs Cachorro";
    this.fundoTema$1 = "#af8379"
  } else if ((x1 === "dinoOro")) {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("temaEscolhidoLabel").innerHTML = "Dinossauro vs Meteoro";
    this.fundoTema$1 = "#e2e2e2"
  } else {
    throw new $c_s_MatchError().init___O(x1)
  }
});
var $d_LMenu$ = new $TypeData().initClass({
  LMenu$: 0
}, false, "Menu$", {
  LMenu$: 1,
  O: 1
});
$c_LMenu$.prototype.$classData = $d_LMenu$;
var $n_LMenu$ = (void 0);
function $m_LMenu$() {
  if ((!$n_LMenu$)) {
    $n_LMenu$ = new $c_LMenu$().init___()
  };
  return $n_LMenu$
}
/** @constructor */
...
function $c_LCasa() {
  $c_O.call(this);
  this.jogador$1 = null;
  this.ocupada$1 = false
}
$c_LCasa.prototype = new $h_O();
$c_LCasa.prototype.constructor = $c_LCasa;
/** @constructor */
function $h_LCasa() {
  /*<skip>*/
}
$h_LCasa.prototype = $c_LCasa.prototype;
$c_LCasa.prototype.productPrefix__T = (function() {
  return "Casa"
});
$c_LCasa.prototype.productArity__I = (function() {
  return 2
});
$c_LCasa.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LCasa(x$1)) {
    var Casa$1 = $as_LCasa(x$1);
    var x = this.jogador$1;
    var x$2 = Casa$1.jogador$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      return (this.ocupada$1 === Casa$1.ocupada$1)
    } else {
      return false
    }
  } else {
...
$c_LCasa.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_LCasa.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LCasa.prototype.init___LJogador__Z = (function(jogador, ocupada) {
  this.jogador$1 = jogador;
  this.ocupada$1 = ocupada;
  return this
});
$c_LCasa.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.jogador$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, (this.ocupada$1 ? 1231 : 1237));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_LCasa.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LCasa(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LCasa)))
}
function $as_LCasa(obj) {
  return (($is_LCasa(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Casa"))
}
function $isArrayOf_LCasa(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LCasa)))
}
function $asArrayOf_LCasa(obj, depth) {
  return (($isArrayOf_LCasa(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LCasa;", depth))
}
var $d_LCasa = new $TypeData().initClass({
  LCasa: 0
}, false, "Casa", {
  LCasa: 1,
  O: 1,
...
$c_LCasa.prototype.$classData = $d_LCasa;
/** @constructor */
function $c_LCoordenada() {
  $c_O.call(this);
  this.x$1 = 0;
  this.y$1 = 0
}
$c_LCoordenada.prototype = new $h_O();
$c_LCoordenada.prototype.constructor = $c_LCoordenada;
/** @constructor */
function $h_LCoordenada() {
  /*<skip>*/
}
$h_LCoordenada.prototype = $c_LCoordenada.prototype;
$c_LCoordenada.prototype.productPrefix__T = (function() {
  return "Coordenada"
});
$c_LCoordenada.prototype.productArity__I = (function() {
  return 2
});
$c_LCoordenada.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LCoordenada(x$1)) {
    var Coordenada$1 = $as_LCoordenada(x$1);
    return ((this.x$1 === Coordenada$1.x$1) && (this.y$1 === Coordenada$1.y$1))
  } else {
    return false
  }
});
$c_LCoordenada.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_LCoordenada.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_LCoordenada.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LCoordenada.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.x$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.y$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_LCoordenada.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LCoordenada(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LCoordenada)))
}
function $as_LCoordenada(obj) {
  return (($is_LCoordenada(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Coordenada"))
}
function $isArrayOf_LCoordenada(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LCoordenada)))
}
function $asArrayOf_LCoordenada(obj, depth) {
  return (($isArrayOf_LCoordenada(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LCoordenada;", depth))
}
var $d_LCoordenada = new $TypeData().initClass({
  LCoordenada: 0
}, false, "Coordenada", {
  LCoordenada: 1,
  O: 1,
...
$c_LCoordenada.prototype.$classData = $d_LCoordenada;
/** @constructor */
function $c_LTabuleiro() {
  $c_O.call(this);
  this.tabuleiro$1 = null
}
$c_LTabuleiro.prototype = new $h_O();
$c_LTabuleiro.prototype.constructor = $c_LTabuleiro;
/** @constructor */
function $h_LTabuleiro() {
  /*<skip>*/
}
$h_LTabuleiro.prototype = $c_LTabuleiro.prototype;
$c_LTabuleiro.prototype.init___ = (function() {
  var array = [new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false), new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false), new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false)];
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
  var len = $uI(xs.array$6.length);
  var array$1 = $newArrayObject($d_LCasa.getArrayOf(), [len]);
  var elem$1 = 0;
  elem$1 = 0;
  ...
  var array$2 = [new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false), new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false), new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false)];
  var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2);
  var len$1 = $uI(xs$1.array$6.length);
  var array$3 = $newArrayObject($d_LCasa.getArrayOf(), [len$1]);
  var elem$1$1 = 0;
  elem$1$1 = 0;
  var this$18 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$1, 0, $uI(xs$1.array$6.length));
  while (this$18.hasNext__Z()) {
    var arg1$1 = this$18.next__O();
    array$3.set(elem$1$1, arg1$1);
    elem$1$1 = ((1 + elem$1$1) | 0)
  };
  var array$4 = [new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false), new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false), new $c_LCasa().init___LJogador__Z(new $c_LJogador().init___T(""), false)];
  var xs$2 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$4);
  var len$2 = $uI(xs$2.array$6.length);
  var array$5 = $newArrayObject($d_LCasa.getArrayOf(), [len$2]);
  var elem$1$2 = 0;
  elem$1$2 = 0;
  var this$27 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$2, 0, $uI(xs$2.array$6.length));
  while (this$27.hasNext__Z()) {
    var arg1$2 = this$27.next__O();
    array$5.set(elem$1$2, arg1$2);
    elem$1$2 = ((1 + elem$1$2) | 0)
  };
  var array$6 = [array$1, array$3, array$5];
  var xs$3 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$6);
  var len$3 = $uI(xs$3.array$6.length);
  var array$7 = $newArrayObject($d_LCasa.getArrayOf().getArrayOf(), [len$3]);
  var elem$1$3 = 0;
  elem$1$3 = 0;
  var this$35 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$3, 0, $uI(xs$3.array$6.length));
  while (this$35.hasNext__Z()) {
    var arg1$3 = this$35.next__O();
    array$7.set(elem$1$3, arg1$3);
    elem$1$3 = ((1 + elem$1$3) | 0)
  };
  this.tabuleiro$1 = array$7;
  return this
});
$c_LTabuleiro.prototype.productPrefix__T = (function() {
  return "Tabuleiro"
});
$c_LTabuleiro.prototype.productArity__I = (function() {
  return 0
});
$c_LTabuleiro.prototype.equals__O__Z = (function(x$1) {
  return ($is_LTabuleiro(x$1) && ($as_LTabuleiro(x$1), true))
});
$c_LTabuleiro.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_LTabuleiro.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LTabuleiro.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LTabuleiro.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LTabuleiro(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LTabuleiro)))
}
function $as_LTabuleiro(obj) {
  return (($is_LTabuleiro(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Tabuleiro"))
}
function $isArrayOf_LTabuleiro(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LTabuleiro)))
}
function $asArrayOf_LTabuleiro(obj, depth) {
  return (($isArrayOf_LTabuleiro(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LTabuleiro;", depth))
}
var $d_LTabuleiro = new $TypeData().initClass({
  LTabuleiro: 0
}, false, "Tabuleiro", {
  LTabuleiro: 1,
  O: 1,
...
$c_LTabuleiro.prototype.$classData = $d_LTabuleiro;
/** @constructor */
function $c_LTemas() {
  $c_O.call(this);
  this.nomeTema$1 = null
}
$c_LTemas.prototype = new $h_O();
$c_LTemas.prototype.constructor = $c_LTemas;
/** @constructor */
function $h_LTemas() {
  /*<skip>*/
}
$h_LTemas.prototype = $c_LTemas.prototype;
$c_LTemas.prototype.jogar1__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador1").setAttribute("class", "infoJogadorTransparente");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador2").setAttribute("class", "infoJogador")
});
$c_LTemas.prototype.productPrefix__T = (function() {
  return "Temas"
});
$c_LTemas.prototype.productArity__I = (function() {
  return 1
});
$c_LTemas.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LTemas(x$1)) {
    var Temas$1 = $as_LTemas(x$1);
    return (this.nomeTema$1 === Temas$1.nomeTema$1)
  } else {
    return false
  }
});
$c_LTemas.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.nomeTema$1;
      break
    }
    default: {
      throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
...
$c_LTemas.prototype.terminarJogoEmpate__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("fimJogoEmpateTela").style.display = "block";
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("barraLateralTela").style.display = "none"
});
$c_LTemas.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LTemas.prototype.atualizarCasaTransparente__T__V = (function(xy) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(xy).setAttribute("class", "casaTransparente")
});
$c_LTemas.prototype.jogar2__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador2").setAttribute("class", "infoJogadorTransparente");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador1").setAttribute("class", "infoJogador")
});
$c_LTemas.prototype.atualizarCasa__T__T__V = (function(posGrid, nomeImg) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(posGrid).innerHTML = (((("<img src=\"../resources/" + this.nomeTema$1) + "/") + nomeImg) + ".png\"/>")
});
$c_LTemas.prototype.init___T = (function(nomeTema) {
  this.nomeTema$1 = nomeTema;
  return this
});
$c_LTemas.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LTemas.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_LTemas.prototype.iniciarTemas__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("console").style.backgroundImage = (("url(../resources/" + this.nomeTema$1) + "/fundo.png)");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador1").style.backgroundImage = (("url(../resources/" + this.nomeTema$1) + "/x.png)");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador2").style.backgroundImage = (("url(../resources/" + this.nomeTema$1) + "/o.png)");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogador2").setAttribute("class", "infoJogadorTransparente");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("tela").style.backgroundColor = $m_LMenu$().fundoTema$1
});
$c_LTemas.prototype.mostrarSequenciaVitoria__sci_List__V = (function(sequencia) {
  this.atualizarCasaTransparente__T__V($as_T(sequencia.head__O()));
  this.atualizarCasaTransparente__T__V($as_T(sequencia.tail__sci_List().head__O()));
  this.atualizarCasaTransparente__T__V($as_T($f_sc_LinearSeqOptimized__last__O(sequencia)))
});
$c_LTemas.prototype.terminarJogo__T__V = (function(nomeImg) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("fimJogoTela").style.display = "block";
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("infoJogadorVencedor").style.backgroundImage = (((("url(../resources/" + this.nomeTema$1) + "/") + nomeImg) + ".png)");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("barraLateralTela").style.display = "none"
});
function $is_LTemas(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LTemas)))
}
function $as_LTemas(obj) {
  return (($is_LTemas(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Temas"))
}
function $isArrayOf_LTemas(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LTemas)))
}
function $asArrayOf_LTemas(obj, depth) {
  return (($isArrayOf_LTemas(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LTemas;", depth))
}
var $d_LTemas = new $TypeData().initClass({
  LTemas: 0
}, false, "Temas", {
  LTemas: 1,
  O: 1,
...
$c_LTemas.prototype.$classData = $d_LTemas;
/** @constructor */
...
/** @constructor */
function $c_LComputador() {
  $c_LJogador.call(this)
}
$c_LComputador.prototype = new $h_LJogador();
$c_LComputador.prototype.constructor = $c_LComputador;
/** @constructor */
function $h_LComputador() {
  /*<skip>*/
}
$h_LComputador.prototype = $c_LComputador.prototype;
$c_LComputador.prototype.productPrefix__T = (function() {
  return "Computador"
});
$c_LComputador.prototype.productArity__I = (function() {
  return 1
});
$c_LComputador.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LComputador(x$1)) {
    var Computador$1 = $as_LComputador(x$1);
    return (this.nomeImg$1 === Computador$1.nomeImg$1)
  } else {
    return false
  }
});
$c_LComputador.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.nomeImg$1;
      break
    }
    default: {
      throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
...
$c_LComputador.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LComputador.prototype.jogarAuto__LCoordenada = (function() {
  var listaPossiveis = this.verificarPossiveis__sci_List__LTabuleiro__I__I__sci_List($m_sci_Nil$(), $m_LJogo$().tab$1, 0, 0);
  var this$1 = $m_s_util_Random$();
  var n = (((-1) + $f_sc_LinearSeqOptimized__length__I(listaPossiveis)) | 0);
  var alatorio = this$1.self$1.nextInt__I__I(n);
  return $as_LCoordenada($f_sc_LinearSeqOptimized__apply__I__O(listaPossiveis, alatorio))
});
$c_LComputador.prototype.verificarPossiveis__sci_List__LTabuleiro__I__I__sci_List = (function(listaPossiveis, tabAtual, x, y) {
  if ((!(!((x <= 2) & (y <= 2))))) {
    if ((x === 2)) {
      if ((!tabAtual.tabuleiro$1.get(x).get(y).ocupada$1)) {
        var elem = new $c_LCoordenada().init___I__I(x, y);
        var this$1 = $m_sci_List$();
        var bf = this$1.ReusableCBFInstance$2;
        return this.verificarPossiveis__sci_List__LTabuleiro__I__I__sci_List($as_sci_List($f_sc_SeqLike__$$colon$plus__O__scg_CanBuildFrom__O(listaPossiveis, elem, bf)), tabAtual, 0, ((1 + y) | 0))
      } else {
        return this.verificarPossiveis__sci_List__LTabuleiro__I__I__sci_List(listaPossiveis, tabAtual, 0, ((1 + y) | 0))
      }
    } else if ((!tabAtual.tabuleiro$1.get(x).get(y).ocupada$1)) {
      var elem$1 = new $c_LCoordenada().init___I__I(x, y);
      var this$2 = $m_sci_List$();
      var bf$1 = this$2.ReusableCBFInstance$2;
      return this.verificarPossiveis__sci_List__LTabuleiro__I__I__sci_List($as_sci_List($f_sc_SeqLike__$$colon$plus__O__scg_CanBuildFrom__O(listaPossiveis, elem$1, bf$1)), tabAtual, ((1 + x) | 0), y)
    } else {
      return this.verificarPossiveis__sci_List__LTabuleiro__I__I__sci_List(listaPossiveis, tabAtual, ((1 + x) | 0), y)
    }
  } else {
    return listaPossiveis
  }
});
$c_LComputador.prototype.init___T = (function(nomeImagem) {
  $c_LJogador.prototype.init___T.call(this, nomeImagem);
  return this
});
$c_LComputador.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LComputador.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LComputador(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LComputador)))
}
function $as_LComputador(obj) {
  return (($is_LComputador(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Computador"))
}
function $isArrayOf_LComputador(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LComputador)))
}
function $asArrayOf_LComputador(obj, depth) {
  return (($isArrayOf_LComputador(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LComputador;", depth))
}
var $d_LComputador = new $TypeData().initClass({
  LComputador: 0
}, false, "Computador", {
  LComputador: 1,
  LJogador: 1,
...
$c_LComputador.prototype.$classData = $d_LComputador;
/** @constructor */
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$e.jogar = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  $m_LJogo$().converterIDParaCoordenada__T__V(prep0)
});
$e.iniciarJogo = (function() {
  $m_LJogo$().iniciarJogo__V()
});
$e.iniciarMenu = (function() {
  $m_LMenu$().iniciarMenu__V()
});
$e.iniciarPartida = (function() {
  $m_LMenu$().iniciarJogo__V()
});
$e.escolherTema = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  $m_LMenu$().escolherTema__T__V(prep0)
});
$e.voltarMenu = (function() {
  $m_LMenu$().voltarMenu__V()
});
}).call(this);
//# sourceMappingURL=jogoidosa-fastopt.js.map
